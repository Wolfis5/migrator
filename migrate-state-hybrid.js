...
class HybridStateMigrator {
    ...
    async getMongoDocuments() {
        const slugs = [
            ...
            `${this.stateSlug}-corporation/start-a-${this.stateCode}-corporation`,
    ...
    async migrate() {
        ...
        if (mongoDocuments[`${this.stateSlug}-corporation`]) {
            const mainHtml = htmlContents[`${this.stateSlug}-corporation`];
        ...
        const childPages = [
            { slug: `${this.stateSlug}-corporation/${this.stateSlug}-taxes`, htmlPath: `${this.stateSlug}-corporation/${this.stateSlug}-taxes`, type: 'business-taxes' },
            { slug: `${this.stateSlug}-corporation/${this.stateSlug}-corporation-names`, htmlPath: `${this.stateSlug}-corporation/${this.stateSlug}-corporation-names`, type: 'business-names' },
            { slug: `${this.stateSlug}-corporation/${this.stateSlug}-incorporation-fees`, htmlPath: `${this.stateSlug}-corporation/${this.stateSlug}-incorporation-fees`, type: 'filing-fees-requirements' },
            { slug: `${this.stateSlug}-corporation/${this.stateSlug}-registered-agents`, htmlPath: `${this.stateSlug}-corporation/${this.stateSlug}-registered-agents`, type: 'registered-agent' },
            { slug: `${this.stateSlug}-corporation/start-a-${this.stateCode}-corporation`, htmlPath: `${this.stateSlug}-corporation/start-a-${this.stateCode}-corporation`, type: 'start-a-corporation' },
            { slug: `${this.stateSlug}-corporation/how-to-name-your-corporation`, htmlPath: `${this.stateSlug}-corporation/how-to-name-your-corporation`, type: 'business-names' },
            { slug: `${this.stateSlug}-corporation/registered-agents-${this.stateSlug}`, htmlPath: `${this.stateSlug}-corporation/registered-agents-${this.stateSlug}`, type: 'registered-agent' },
            { slug: `${this.stateSlug}-corporation/taxes-and-fees-for-your-corporation`, htmlPath: `${this.stateSlug}-corporation/taxes-and-fees-for-your-corporation`, type: 'business-taxes' },
        ];
...
async function main() {
    ...
    const migrator = new HybridStateMigrator(stateSlug, stateNumber);
...
module.exports = { HybridStateMigrator };
